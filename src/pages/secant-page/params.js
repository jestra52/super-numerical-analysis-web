...
const CtrlSecantParams = ({
    ...
    const secantParamsClass = classNames(
        className,
        classes.secantParams
    );

    const { DECIMALS_FOR_FIELDS, DECIMALS_FOR_TOLERANCE } = constants.numbers;

    return (
        <Paper className={secantParamsClass} id={id}>
...
export default withStyles(styles)(CtrlSecantParams);
