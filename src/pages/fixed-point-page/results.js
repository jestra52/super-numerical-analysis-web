...
CtrlFixedPointsResults.propTypes = {
...
CtrlFixedPointsResults.defaultProps = {
    data: [],
    visible: true
};

export default withStyles(styles)(CtrlFixedPointsResults);
