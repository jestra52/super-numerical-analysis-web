...
const CtrlFixedPointsParams = ({
    ...
    const fixedPointParamsClass = classNames(
        className,
        classes.fixedPointParams
    );

    const { DECIMALS_FOR_FIELDS, DECIMALS_FOR_TOLERANCE } = constants.numbers;

    return (
        <Paper className={fixedPointParamsClass} id={id}>
...
CtrlFixedPointsParams.propTypes = {
...
CtrlFixedPointsParams.defaultProps = {
    className: null,
    isRelError: null,
    iterations: null,
    tolerance: null,
...
export default withStyles(styles)(CtrlFixedPointsParams);
